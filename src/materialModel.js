...
export const OPENPBR_SCHEMA = [
  ["base_weight", "Base weight", "float", 1, 0, 1, 0.01, "Base", "advanced"],
  ["base_color", "Base color", "color3", [0.8, 0.8, 0.8], 0, 1, 0.01, "Base", "simple"],
  ...
  ["specular_weight", "Specular weight", "float", 1, 0, 1, 0.01, "Specular", "advanced"],
  ["specular_color", "Specular color", "color3", [1, 1, 1], 0, 1, 0.01, "Specular", "advanced"],
  ["specular_roughness", "Roughness", "float", 0.3, 0, 1, 0.01, "Specular", "simple"],
  ["specular_ior", "IOR", "float", 1.5, 1, 3, 0.01, "Specular", "simple"],
  ["specular_roughness_anisotropy", "Anisotropy", "float", 0, 0, 1, 0.01, "Specular", "simple"],
  ["transmission_weight", "Transmission", "float", 0, 0, 1, 0.01, "Transmission", "advanced"],
  ["transmission_color", "Transmission color", "color3", [1, 1, 1], 0, 1, 0.01, "Transmission", "advanced"],
  ["transmission_depth", "Transmission depth", "float", 0, 0, 10, 0.01, "Transmission", "advanced"],
  ["transmission_scatter", "Transmission scatter", "color3", [0, 0, 0], 0, 1, 0.01, "Transmission", "advanced"],
  ["transmission_scatter_anisotropy", "Transmission anisotropy", "float", 0, -1, 1, 0.01, "Transmission", "advanced"],
  ["transmission_dispersion_scale", "Dispersion scale", "float", 0, 0, 1, 0.01, "Transmission", "advanced"],
  ["transmission_dispersion_abbe_number", "Abbe number", "float", 20, 0, 100, 1, "Transmission", "advanced"],
  ["subsurface_weight", "Subsurface", "float", 0, 0, 1, 0.01, "Subsurface", "advanced"],
  ["subsurface_color", "Subsurface color", "color3", [0.8, 0.8, 0.8], 0, 1, 0.01, "Subsurface", "advanced"],
  ["subsurface_radius", "Subsurface radius", "float", 1, 0, 10, 0.01, "Subsurface", "advanced"],
  ["subsurface_radius_scale", "Radius scale", "color3", [1, 0.5, 0.25], 0, 1, 0.01, "Subsurface", "advanced"],
  ["subsurface_scatter_anisotropy", "SSS anisotropy", "float", 0, -1, 1, 0.01, "Subsurface", "advanced"],
  ["fuzz_weight", "Fuzz", "float", 0, 0, 1, 0.01, "Fuzz", "simple"],
  ["fuzz_color", "Fuzz color", "color3", [1, 1, 1], 0, 1, 0.01, "Fuzz", "advanced"],
  ["fuzz_roughness", "Fuzz roughness", "float", 0.5, 0, 1, 0.01, "Fuzz", "advanced"],
  ["coat_weight", "Coat", "float", 0, 0, 1, 0.01, "Coat", "simple"],
  ["coat_color", "Coat color", "color3", [1, 1, 1], 0, 1, 0.01, "Coat", "advanced"],
  ["coat_roughness", "Coat roughness", "float", 0, 0, 1, 0.01, "Coat", "simple"],
  ["coat_roughness_anisotropy", "Coat anisotropy", "float", 0, 0, 1, 0.01, "Coat", "advanced"],
  ["coat_ior", "Coat IOR", "float", 1.6, 1, 3, 0.01, "Coat", "advanced"],
  ["coat_darkening", "Coat darkening", "float", 1, 0, 1, 0.01, "Coat", "advanced"],
  ["thin_film_weight", "Thin film", "float", 0, 0, 1, 0.01, "Thin Film", "simple"],
  ["thin_film_thickness", "Thickness um", "float", 0.5, 0, 1.2, 0.001, "Thin Film", "simple"],
  ["thin_film_ior", "Thin film IOR", "float", 1.4, 1, 3, 0.01, "Thin Film", "advanced"],
  ["emission_luminance", "Luminance", "float", 0, 0, 1000, 1, "Emission", "simple"],
  ["emission_color", "Emission color", "color3", [1, 1, 1], 0, 1, 0.01, "Emission", "simple"],
